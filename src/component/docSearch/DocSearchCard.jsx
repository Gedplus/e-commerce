...
import { addWishlist, editDocumentDE, editDocumentDI, editDocumentDU, editDocumentE, editDocumentI, editDocumentP, editDocumentU, getDocUni, getSearch, useGetDocumentQuery, useGetUtilisateursQuery } from '../../state/api'
import { Button, CardActions, CircularProgress } from "@mui/material";
import ThumbUpOffAltIcon from '@mui/icons-material/ThumbUpOffAlt';
import Pagination from "../shop/pagination";
const DocSearchCard = ({ shopItems, addToCart ,user}) => {
...
addWishlist(id, idu)
  ...
  return (
    <>     
    {currentRecords.length ===  0  ? (<>Il n'y a aucun résultat pour votre recherche</>) : (
    ...
    {users === undefined  ? (<> <CircularProgress className="addProgress1" /></>) : (<>
    
    {currentRecords.map((shopItems, index) => { 
        return (
        <> 
